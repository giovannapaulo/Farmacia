Sistema de Gerenciamento de Farmácia - Microsserviços 
Projeto desenvolvido para a rede de farmácias com o objetivo de refatorar o sistema monolítico para uma arquitetura distribuída de microsserviços.  

Arquitetura do SistemaO sistema foi projetado em duas versões para demonstrar a evolução de comunicação entre serviços.

Versão 1: Comunicação Síncrona baseada em REST (HTTP).  
